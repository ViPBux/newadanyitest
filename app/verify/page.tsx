...
const Page = () => {
  ...
  const handleShowLess = () => setDisplayCount(8);
  ...
  return (
    <div className="bg-gray-200 flex flex-col items-center gap-5 px-4 py-[60px]">
      ...
      {/* AdBlock Warning */}
      {isAdBlocked && (
        <div className="bg-red-500 text-white text-center p-3 rounded-md max-w-6xl w-full">
          ⚠️ Ad blocker detected! Please disable it to see available offers.
        </div>
      )}
